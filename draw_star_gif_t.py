...
with tempfile.TemporaryDirectory() as tmpdir:
    ...
    rs = [2 for t in thetas] #[ellipse_tools.min_r_given_theta(t, a) for t in thetas]
    min_r = min(rs)
    max_r = max(rs)
    ...
    for theta, r in zip(thetas, rs):
        ...
        color = 'red' #(1 - (r-min_r)/(max_r-min_r), 0.3, (r - min_r) / (max_r - min_r))
        ellipse_tools.plot_k_points_d_Euclid_apart(5, r, theta, a, img_name = f"{tmpdir}/{i}.png", verbose = False, star_color = color)
